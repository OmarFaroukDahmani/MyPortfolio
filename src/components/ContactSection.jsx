  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await emailjs.sendForm(
        "service_nvfzbgj",          // your service ID
        "template_r5an66n",         // your template ID
        formRef.current,            // form reference
        "lLvFu41Qe0e1Qq20D"         // your public key
      );
            ...
            <div className="pt-10">
              ...
              <div className="flex justify-center space-x-6">
                {[
                  ...
                  <a key={i} href={link} target="_blank" rel="noopener noreferrer" className="transition-transform hover:scale-110">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  name="from_name"
                  required
                  className="w-full px-4 py-3 rounded-lg border border-input bg-background shadow-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="w-full px-4 py-3 rounded-lg border border-input bg-background shadow-sm resize-none"
              ...
              <button
                ...
                className={cn(
                  "cosmic-button w-full flex items-center justify-center gap-2 py-3 text-lg font-medium rounded-lg",
